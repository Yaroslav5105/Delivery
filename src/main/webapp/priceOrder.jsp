...
<div class="Myform">
            <h1><fmt:message key="Edit.price" /></h1>
            <div class="inp">
                         <form  method="post" action="/controller">
                                   <input type="hidden" name="command" value="priceOrder"/>
                                   <c:forEach var="price" items="${prices}"  >
                                   <fmt:message key="price.kilometer" /><input class="log" name="kilometer" value="${price.kilometer}" required>
                                   <fmt:message key="manager.List.Order.Volume" /><input class="log" name="volume" value="${price.volume}" required>
                                   <fmt:message key="manager.List.Order.Weight" /><input class="log" name="weight" value="${price.weight}" required >
                                   </c:forEach>
                                   <div class="info">
