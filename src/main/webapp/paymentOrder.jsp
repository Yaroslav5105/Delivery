            ...
            <div class="inp">
                         <form  method="post" action="/controller">
                                 ...
                                 <input type="hidden" name="id" value="${orderId}"/>
                                    ...
                                    <fmt:message  key="pay.number" /> <input class="log" type="number" placeholder="number card"required/> <br/>
                                    <fmt:message key="pay.srok" /><input class="log"type="number" placeholder="validity" required/></br>
                                    <fmt:message key="pay" /><input class="pass" type="number" placeholder="CVV"required/> <br/>
                                    <div class="info">

                                   </div>
                                   <input class="btn" type="submit" value=<fmt:message key="manager.List.Order.Pay" /> >
                        </form>
            </div>
</div>
